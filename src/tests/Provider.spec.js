...
describe('<Provider />', () => {
  ...
  it('renders successfully', () => {
    const wrapper = shallow(<div><Provider router={router}><div className="main">content</div></Provider></div>);
  ...
  it('calls init function from RouteFactory with proper arguments', () => {
    ...
    shallow(<Provider router={router}><div className="main">content</div></Provider>, options);
